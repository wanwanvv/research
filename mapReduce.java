...
public class InvertIndex_origin {
    ...
    public static class Map extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            StringTokenizer itr = new StringTokenizer(value.toString());
             /**********Begin**********/
            int i = split.getPath().toString().lastIndexOf("/");
            while(itr.hasMoreTokens()){
                keyInfo.set(itr.nextToken()+":"+split.getPath().toString().substring(i+1));
                valueInfo.set("1");
   ...
   /**********Begin**********/
            ...
            info.set(key.toString().substring(i+1)+":"+sum);
            // 重新设置key值为单词
   key.set(key.toString().substring(0,i));
